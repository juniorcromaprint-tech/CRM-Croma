...
import { Printer, FileText, Loader2, ChevronLeft, MapPin, CheckCircle2 } from "lucide-react";
    ...
    <div className="space-y-6 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 print:hidden">
        <div>
          ...
          <p className="text-slate-500">Consolidado de instalações concluídas.</p>
        </div>
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 pt-2 border-t border-slate-50">
                    <div>
                      ...
                      <p className="text-xs text-slate-600 italic">{job.notes || "Sem observações."}</p>
                    </div>
                    {job.signature_url && (
                      <div className="flex flex-col items-end">
                        <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Assinatura</p>
