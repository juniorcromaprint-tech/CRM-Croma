...
export const LEAD_STATUS_CONFIG: Record<LeadStatus, StatusConfig> = {
  novo: { label: 'Novo', color: 'bg-blue-100 text-blue-700 border-blue-200', icon: 'Plus' },
  contatado: { label: 'Contatado', color: 'bg-sky-100 text-sky-700 border-sky-200', icon: 'Phone' },
  qualificado: { label: 'Qualificado', color: 'bg-emerald-100 text-emerald-700 border-emerald-200', icon: 'CheckCircle' },
  proposta_enviada: { label: 'Proposta Enviada', color: 'bg-amber-100 text-amber-700 border-amber-200', icon: 'Send' },
  negociando: { label: 'Negociando', color: 'bg-purple-100 text-purple-700 border-purple-200', icon: 'MessageSquare' },
  convertido: { label: 'Convertido', color: 'bg-green-100 text-green-700 border-green-200', icon: 'UserCheck' },
