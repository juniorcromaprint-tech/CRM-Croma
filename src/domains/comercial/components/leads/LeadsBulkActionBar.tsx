        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-red-700">
              ⚠ Excluir {count} lead{count !== 1 ? 's' : ''} permanentemente?
            </AlertDialogTitle>
            <AlertDialogDescription asChild>
              <div className="space-y-3">
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg px-3 py-2 text-sm text-red-800">
                  ...
                  {count !== 1 ? 'Os leads' : 'O lead'} {count !== 1 ? 'vão sumir' : 'vai sumir'} da listagem para sempre e não {count !== 1 ? 'podem' : 'pode'} ser {count !== 1 ? 'recuperados' : 'recuperado'} pela tela.
                </div>
              </div>
          ...
          <AlertDialogFooter>
            ...
            >
              {excluirEmLote.isPending ? 'Excluindo...' : `Excluir ${count} permanentemente`}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
